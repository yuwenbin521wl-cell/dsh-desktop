...
const MESSAGES = {
  zh: {
    ...
    // 引擎更新进度
    'prog.title': '引擎更新',
    'prog.checking': '正在检查引擎更新…',
    'prog.downloading': '正在下载 v{version}… {pct}%（{mb} / {totalMb} MB）',
  ...
  en: {
    ...
    'prog.title': 'Engine Update',
    'prog.checking': 'Checking for engine updates…',
    'prog.downloading': 'Downloading v{version}… {pct}% ({mb} / {totalMb} MB)',
